...
import EmailVerifyCeleb from "./Components/EmailVerifyCeleb";
import ForgotPassword from "./Components/ForgotPassword";
import PasswordReset from "./Components/PasswordReset";
import PasswordResetCeleb from "./Components/PasswordResetCeleb";
import StripeContainer from "./Components/StripeContainer";
import FanProfile from "./Pages/FanProfile";
import ForgotPasswordCeleb from "./Components/ForgotPasswordCeleb";
      ...
      <div className="App">
        <UserContext.Provider value={{ state, dispatch }}>
          ...
          <Routes>
            ...
            <Route
              path="/fan-schedule"
              element={<Schedule msg="join meeting" />}
            />
            ...
            <Route path="/celeb-login" element={<CelebLogin />} />
            <Route
              path="/fan-login"
              element={
                <FanLogin
                  setCurrentUser={setCurrentUser}
                  setFanProps={setFanProps}
                />
              }
            />
            ...
            <Route
              path="/profile/:slug"
              element={<Profile setCurrentId={setCurrentId} />}
            />

            <Route
              path="/FanProfile/:slug"
              element={<FanProfile setCurrentId={setCurrentId} />}
            />
            <Route
              path="/FanProfile/edit-profile/:slug"
              element={
                <FanEditProfile
                  currentId={currentId}
            ...
            />
            <Route
              path="/profile/edit-profile/:slug"
              element={
                <EditProfile
                  currentId={currentId}
                  setCurrentId={setCurrentId}
